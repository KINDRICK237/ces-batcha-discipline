...
<head>
    ...
    <title>Élèves — CES de Batcha</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .barre-gauche { display: flex; align-items: center; gap: 10px; }
        select {
            padding: 9px 12px;
        ...
        .statut-suspendu  { background: #fff3e0; color: #e65100; }
        .statut-exclu     { background: #fce4ec; color: #c62828; }
        .statut-transfere { background: #f3e5f5; color: #6a1b9a; }
        .badge-genre-m {
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="eleves" class="menu-item actif">👨‍🎓 Élèves</a>
        ...
        <div class="zone-principale">
            ...
            <div class="barre-outils">
                <div class="barre-gauche">
                    <form method="get" action="eleves" style="display:flex; gap:8px;">
                ...
                <% if (utilisateur.isAdmin()) { %>
                <a href="eleves?action=ajouter" class="btn-ajouter">➕ Ajouter un élève</a>
                <% } %>
            </div>
            ...
            <div class="carte-tableau">
                <div class="carte-tableau-entete">
                    ...
                    <span class="badge-total"><%= eleves != null ? eleves.size() : 0 %> élève(s)</span>
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="8" class="vide">Aucun élève enregistré</td>
                        </tr>
                        <% } else { for (Eleve e : eleves) { %>
                        <tr>
                            ...
                            <td><%= e.getClasseNom() %></td>
                            <td><%= e.getNomParent() != null ? e.getNomParent() : "-" %></td>
                            <td><%= e.getTelephoneParent() != null ? e.getTelephoneParent() : "-" %></td>
                            <td>
                                <span class="badge-statut statut-<%= e.getStatut().toLowerCase() %>">
                                    <%= e.getStatut() %>
                                </span>
                            </td>
                            <% if (utilisateur.isAdmin()) { %>
                            <td>
                                <div class="actions">
                                    <a href="eleves?action=modifier&id=<%= e.getId() %>" class="btn-modifier">✏️ Modifier</a>
                                    <a href="eleves?action=supprimer&id=<%= e.getId() %>" class="btn-supprimer" onclick="return confirm('Supprimer cet eleve ?')">🗑️ Supprimer</a>
                                </div>
                            </td>
                            <% } %>
                        </tr>
