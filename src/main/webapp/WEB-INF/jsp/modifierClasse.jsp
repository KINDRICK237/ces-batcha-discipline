...
<head>
    ...
    <title>Modifier une classe — CES de Batcha</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-enregistrer:hover { background: #bf360c; }
        .btn-annuler {
            padding: 11px 25px;
            background: #eceff1;
            color: #37474f;
                    ...
                    <form method="post" action="classes">
                        ...
                        <div class="champ-groupe">
                            ...
                            <select name="niveau" required>
                                <option value="6ème" <%= "6ème".equals(classe.getNiveau()) ? "selected" : "" %>>6ème</option>
                                <option value="5ème" <%= "5ème".equals(classe.getNiveau()) ? "selected" : "" %>>5ème</option>
                                <option value="4ème" <%= "4ème".equals(classe.getNiveau()) ? "selected" : "" %>>4ème</option>
                                <option value="3ème" <%= "3ème".equals(classe.getNiveau()) ? "selected" : "" %>>3ème</option>
                            </select>
                        </div>
                        ...
                        <div class="champ-groupe">
                            ...
                            <select name="anneeScolaire" required>
                                <option value="2024-2025" <%= "2024-2025".equals(classe.getAnneeScolaire()) ? "selected" : "" %>>2024-2025</option>
                                <option value="2025-2026" <%= "2025-2026".equals(classe.getAnneeScolaire()) ? "selected" : "" %>>2025-2026</option>
                                <option value="2026-2027" <%= "2026-2027".equals(classe.getAnneeScolaire()) ? "selected" : "" %>>2026-2027</option>
                            </select>
                        </div>
