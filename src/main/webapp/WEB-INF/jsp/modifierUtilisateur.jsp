...
<head>
    ...
    <title>Modifier utilisateur — CES de Batcha</title>
    <style>
            ...
            <div class="carte-form">
                ...
                <div class="carte-form-corps">
                    <form method="post" action="utilisateurs">
                        ...
                        <div class="separateur">Identité</div>
                        <div class="grille-2">
                        ...
                        <div class="separateur">Compte</div>
                        <div class="champ-groupe">
                            <label>Email *</label>
                        ...
                        <div class="barre-boutons">
                            ...
                            <a href="utilisateurs" class="btn-annuler">
                                ❌ Annuler
                            </a>
                        </div>
                    </form>
